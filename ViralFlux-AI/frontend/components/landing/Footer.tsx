...
export function Footer() {
  return (
    <footer className="relative border-t border-[#1a1a1a] bg-[#0a0a0a]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-xs text-[#888] leading-relaxed max-w-xs">
              AI-powered platform for turning long-form content into viral short-form clips.
            </p>
          </div>
        ...
        <div className="mt-10 pt-6 border-t border-[#1a1a1a] flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-[#666]">
            &copy; {new Date().getFullYear()} ViralFlux AI. All rights reserved.
          </p>
